...
export const services: Service[] = [
  ...
  { name: "Ударно-волновая терапия (УВТ) — 1 зона", price: 2800, category: "Лечение боли и суставов", link: "/uvt-spb", result: "Уменьшение боли, снижение воспаления, улучшение подвижности" },
  { name: "Ударно-волновая терапия (УВТ) — 2 зоны", price: 4500, category: "Лечение боли и суставов", link: "/uvt-spb", result: "Комплексное воздействие на две проблемные зоны" },
  { name: "Ударно-волновая терапия (УВТ) — 3 зоны", price: 6500, category: "Лечение боли и суставов", link: "/uvt-spb", result: "Максимальный охват: три зоны за одну процедуру" },
