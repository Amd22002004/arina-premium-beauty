...
import { Check, ChevronRight, Sparkles, X, Droplets } from "lucide-react";
...
const prices = [
  { name: "Стоунтерапия (60 мин)", price: "3 000 ₽" },
...
const types = [
  { title: "Стоунтерапия", desc: "Массаж горячими камнями для глубокого прогрева, снятия мышечного напряжения и полного расслабления." },
  ...
  { title: "Комплекс (капсула + выкатка)", desc: "Сочетание инфракрасного прогрева и медовой выкатки для максимального эффекта." },
];
