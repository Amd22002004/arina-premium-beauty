...
const prices = [
  ...
  { name: "BBL комбо (лицо + шея)", price: "от 11 000 ₽" },
...
const benefits = [
  ...
  "Удаление сосудистых проявлений (купероз, розацеа)",
    ...
    <section className="py-14 md:py-20 bg-cream">
      <div className="container-wide px-4 md:px-8 text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
          ...
          Выравнивание тона кожи, осветление, устранение пигментации и удаление сосудистых проявлений (купероз, розацеа)
        </motion.p>
