...
const categories: { label: string; key: string; groups: ServiceGroup[] }[] = [
  {
    ...
    key: "face",
    groups: [
      { title: "Массаж лица", desc: "Скульптурный, миофасциальный, 3D-массаж, флиптинг, INDIBA — ручные и аппаратные техники для подтяжки овала и тонуса кожи", items: ["Скульптурный массаж лица", "Миофасциальный массаж лица", "Массаж лица 3D", "Удаление второго подбородка + подтяжка овала", "Флиптинг", "INDIBA"], link: "/massazh-lica-spb" },
      ...
      { title: "Аппаратные процедуры лица", desc: "Холодная плазма, лазерная шлифовка CO₂, BBL фотоомоложение, микроигольчатый RF-лифтинг", items: ["Холодная плазма", "Лазерная шлифовка лица (CO₂)", "BBL фотоомоложение", "Микроигольчатый RF-лифтинг"], link: "/aparatnye-protokoly-lica-spb" },
  ...
  },
  {
    ...
    key: "massage",
    groups: [
      { title: "Восстановительный массаж", desc: "ШВЗ, спина, глубокий, классический, расслабляющий, оздоровительный, тайский массаж", items: ["ШВЗ (30 мин)", "Спина (30 мин)", "Глубокий массаж (ШВЗ + спина)", "Расслабляющий массаж", "Классический массаж", "Оздоровительный массаж", "Тайский массаж"], link: "/massazh-tela-spb" },
      { title: "Лимфодренажный и висцеральный", desc: "Дренаж, снятие отёков, вакуумно-роликовый, BMS, INDIBA, гуаша", items: ["Лимфодренажный массаж", "Висцеральный массаж"], link: "/vosstanovitelnye-massazhi-spb" },
    ],
  },
  {
    label: "Дополнительно",
    key: "extra",
    groups: [
      { title: "СПА и восстановление", desc: "Стоунтерапия, инфракрасная капсула, медовая выкатка, обёртывания", items: ["Стоунтерапия", "Инфракрасная капсула", "Медовая выкатка", "Обёртывания"], link: "/spa-i-vosstanovlenie-spb" },
      ...
      { title: "Дополнительные услуги", desc: "Гуаша, Body Sculpt, кресло Кегеля", items: ["Гуаша (лицо / тело)", "Body Sculpt", "Кресло Кегеля"], link: "/dopolnitelnye-uslugi-spb" },
      { title: "Оздоровительные процедуры", desc: "Хиджама и гирудотерапия — по индивидуальной консультации", items: ["Хиджама", "Гирудотерапия"], link: "/ozdorovitelnye-procedury-spb" },
      { title: "Курсы и комплексы", desc: "Готовые программы процедур с выгодной ценой", items: ["Курс омоложения лица", "Курс коррекции фигуры", "Курс лимфодренажа", "Курс восстановления"], link: "/kursy-i-kompleksy" },
    ],
  },
];
