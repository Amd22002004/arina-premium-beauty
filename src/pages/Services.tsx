        ...
        <div className="space-y-8">
          {serviceGroups.map((g: ServiceGroup, i) => (
            <motion.div key={g.title} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={i} variants={fadeUp}
              ...
              {g.title === "Восстановительные массажи" && (
                <div className="mt-5">
                  <Link to="/vosstanovitelnye-massazhi-spb">
                    <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                      Подробнее <ChevronRight size={14} className="ml-1" />
                    </Button>
                  </Link>
              ...
              {g.title === "СПА и восстановление" && (
                <div className="mt-5">
                  <Link to="/spa-i-vosstanovlenie-spb">
                    <Button variant="outline" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                      Подробнее <ChevronRight size={14} className="ml-1" />
                    </Button>
                  </Link>
