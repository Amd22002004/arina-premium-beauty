...
import massazhTelaHeroBg from "@/assets/massazh-tela-hero-bg.jpg";
...
const MassazhTelaSpb = () => (
  <Layout>
    ...
    <section
      ...
      style={{ backgroundImage: `url(${massazhTelaHeroBg})` }}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-background/90 via-background/70 to-background/40 md:from-background/85 md:via-background/60 md:to-background/20" />
