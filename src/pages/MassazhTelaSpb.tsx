...
const prices = [
  { name: "ШВЗ (30 мин)", price: "2 500 ₽", priceValue: 2500, tiers: [{ count: 5, total: 11250 }, { count: 10, total: 21250 }] },
  { name: "Спина (30 мин)", price: "2 500 ₽", priceValue: 2500, tiers: [{ count: 5, total: 11250 }, { count: 10, total: 21250 }] },
  { name: "Глубокий массаж (ШВЗ + спина)", price: "3 500 ₽", priceValue: 3500, tiers: [{ count: 5, total: 15750 }, { count: 10, total: 29750 }] },
];
...
const types = [
  ...
  { title: "Медицинский / лечебный массаж", desc: "Глубокая проработка мышц и тканей. Помогает при болях в спине и восстановлении после травм." },
];
...
const MassazhTelaSpb = () => (
  <Layout>
    <Helmet>
      ...
      <meta name="description" content="Массаж тела в СПб: лечебный, лимфодренажный, спина и ШВЗ. От 2 500 ₽. Снятие напряжения и улучшение самочувствия. Запись онлайн." />
      <meta name="keywords" content="массаж тела спб, лечебный массаж спб, массаж спины спб, массаж швз спб" />
    ...
    <section className="py-14 md:py-20 bg-cream">
      <div className="container-wide px-4 md:px-8 text-center">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.25 }}
          className="text-primary font-heading text-2xl md:text-3xl mb-8">от 2&nbsp;500&nbsp;₽</motion.p>
