...
const courses: Course[] = [
  {
    ...
    subtitle: "Комплексная программа для молодости и сияния кожи + гуаша в подарок",
    icon: Sparkles,
  ...
  },
  {
    ...
    badgeIcon: Zap,
    includes: [
      "Вакуумно-роликовый массаж (4D)",
      "Горячий вакуум",
      "Вакуумно-вибрационный массаж",
      "Кавитация",
      "EMS",
      "BMS",
      "MTS-липосоник",
