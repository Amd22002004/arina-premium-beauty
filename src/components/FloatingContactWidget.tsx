...
const FloatingContactWidget = () => {
  ...
  const openChat = () => {
    ...
    if (messages.length === 0) {
      const greeting: Msg = {
        role: "assistant",
        content: "Здравствуйте! 👋 Добро пожаловать в приватную студию «АРТ Косметология». Здесь камерная атмосфера и персональный подход. Подскажите, что вас интересует: лицо, тело или восстановление? 😊",
      };
