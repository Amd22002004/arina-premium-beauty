...
const recommendations: Record<string, string[]> = {
  ...
  "/korrekciya-figury-spb": ["/goryachiy-vakuum-spb", "/vakuumnyj-massazh-spb", "/rf-lifting-tela-spb"],
  "/goryachiy-vakuum-spb": ["/vakuumnyj-massazh-spb", "/rf-lifting-tela-spb", "/korrekciya-figury-spb"],
  "/vakuumnyj-massazh-spb": ["/goryachiy-vakuum-spb", "/rf-lifting-tela-spb", "/korrekciya-figury-spb"],
  "/rf-lifting-tela-spb": ["/goryachiy-vakuum-spb", "/vakuumnyj-massazh-spb", "/korrekciya-figury-spb"],
