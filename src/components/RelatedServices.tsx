...
export const allServices = [
  ...
  { title: "Аппаратные процедуры лица", path: "/aparatnye-protokoly-lica-spb", short: "RF, INDIBA, холодная плазма, БМС", category: "face" },
  ...
  { title: "Коррекция фигуры", path: "/korrekciya-figury-spb", short: "Кавитация, LPG, прессотерапия", category: "body" },
...
const recommendations: Record<string, string[]> = {
  ...
  "/aparatnye-protokoly-lica-spb": ["/frakcionnyy-lazer-co2-spb", "/fotoomolozhenie-bbl-spb", "/massazh-lica-spb"],
